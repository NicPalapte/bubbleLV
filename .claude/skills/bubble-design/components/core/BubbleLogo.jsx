// Bubble — logo lockup: 3 linked nodes + lowercase wordmark. The only illustrative mark.
export function BubbleLogo({ size = 22 }) {
  return (
    <div style={{ display:'inline-flex', alignItems:'center', gap:9 }}>
      ...
      <span style={{ fontFamily:'var(--sans)', fontWeight:700, fontSize:size - 4,
        letterSpacing:'var(--ls-title)', color:'var(--ink)' }}>bubble</span>
    </div>
  );
}
